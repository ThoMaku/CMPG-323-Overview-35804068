...
Project5: '*.pbix' contain the reports, including data connections and visuals, they are binary an dnot suitable for version control, as they can become large and change frequently
